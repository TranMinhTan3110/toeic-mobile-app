...
class ReadingPart7HistoryDetailScreen extends StatefulWidget {
  ...
  @override
  State<ReadingPart7HistoryDetailScreen> createState() =>
      _ReadingPart7HistoryDetailScreenState();
}

class _ReadingPart7HistoryDetailScreenState
    extends State<ReadingPart7HistoryDetailScreen> {
  ...
  Widget _buildBottomControls(
    ...
    List<ReadingPart7Question> sessionQuestions,
  ) {
    return Container(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ReadingPart7HistoryOverviewScreen(
