    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          ReadingSectionCard(title: 'Phần 6 - Điền Vào Đoạn Văn', correctCount: '0/0', showLock: true),
          const SizedBox(height: 12),
          ReadingSectionCard(title: 'Phần 7 - Đọc Hiểu Đoạn Văn', correctCount: '0/0', showLock: true),
        ],
      ),
    );
  }
