...
class ReadingPart6HistoryOverviewScreen extends StatelessWidget {
  final ReadingPart6HistoryModel historyItem;
  final List<ReadingPart6Question> sessionQuestions;

  const ReadingPart6HistoryOverviewScreen({super.key, required this.historyItem, required this.sessionQuestions});
