...
import 'reading_part7_history_swipe_screen.dart';

class ReadingPart7HistoryOverviewScreen extends StatefulWidget {
  final ReadingPart7HistoryModel historyItem;
  final List<ReadingPart7Question> sessionQuestions;

  const ReadingPart7HistoryOverviewScreen({
    super.key,
  ...
  @override
  State<ReadingPart7HistoryOverviewScreen> createState() =>
      _ReadingPart7HistoryOverviewScreenState();
}

class _ReadingPart7HistoryOverviewScreenState
    extends State<ReadingPart7HistoryOverviewScreen> {
  String _activeFilter = 'Tất cả';

  List<ReadingPart7Question> get _filteredQuestions {
  ...
  Widget _buildQuestionRow(ReadingPart7Question q, int originalIdx) {
    final selectedAns = widget.historyItem.selectedAnswers[q.id];
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => ReadingPart7HistorySwipeScreen(
  ...
  Widget _buildChoiceCircles(ReadingPart7Question q, String? selectedAns) {
...
class _ExplanationBottomSheet extends StatefulWidget {
  final ReadingPart7Question question;
