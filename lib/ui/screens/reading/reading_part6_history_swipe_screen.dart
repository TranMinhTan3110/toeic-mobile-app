...
class ReadingPart6HistorySwipeScreen extends StatefulWidget {
  final ReadingPart6HistoryModel historyItem;
  final List<ReadingPart6Question> sessionQuestions;
  final int startIndex;

  const ReadingPart6HistorySwipeScreen({super.key, required this.historyItem, required this.sessionQuestions, required this.startIndex});

  @override
  State<ReadingPart6HistorySwipeScreen> createState() => _ReadingPart6HistorySwipeScreenState();
}

class _ReadingPart6HistorySwipeScreenState extends State<ReadingPart6HistorySwipeScreen> {
